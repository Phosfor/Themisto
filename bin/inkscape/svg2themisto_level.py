...
class Svg2Themisto_Shape(inkex.Effect):
    ...
    def dumpXML(self):
        ...
        fileLocation = os.path.join(self.options.directory, self.options.filename) + '.tpl'
        ...
        for fixture in self.fixturesList:
            ...
            if fixture[0] == "e_polygon":
                ...
                fileHandle.write('       <x>'+ str(fixture[2][0]) +'</x>\n')
