...
Sky::Sky()
{
    ...
    quad1 = CL_Rectf(0, 0, ScreenResolutionX, ScreenResolutionY/2.0);
    quad2 = CL_Rectf(0, ScreenResolutionY/2.0, ScreenResolutionX, ScreenResolutionY);
}
...
bool Sky::checkCollision(CL_Pointf point) { return false; }

CL_Rectf Sky::getRectangle()
{
    return CL_Rectf(0, 0, ScreenResolutionX, ScreenResolutionY);
}

CL_Pointf Sky::getPosition()
{
    return CL_Pointf(0, 0);
}

void Sky::setPosition(CL_Pointf newPos)
{
}
